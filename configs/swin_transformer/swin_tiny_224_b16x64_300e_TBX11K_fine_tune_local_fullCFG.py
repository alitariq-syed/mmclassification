...
data = dict(
    ...
    train=dict(
        type='ImageNet',
        data_prefix='../mmdetection/data/TBX11K/imgs_local/',
        ann_file='../mmdetection/data/TBX11K/imgs_local/x_train.txt',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
                type='RandomResizedCrop',
    ...
    val=dict(
        type='ImageNet',
        data_prefix='../mmdetection/data/TBX11K/imgs_local/',
        ann_file='../mmdetection/data/TBX11K/imgs_local/x_test.txt',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
                type='Resize',
    ...
    test=dict(
        type='ImageNet',
        data_prefix='../mmdetection/data/TBX11K/imgs_local/',
        ann_file='../mmdetection/data/TBX11K/lists/x_test.txt',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
                type='Resize',
...
log_level = 'INFO'
load_from = './tutorial_swin_C1/swin_tiny_224_TBX11K_C1_best_model_20220211-0f9c0e64.pth'
resume_from = None
workflow = [('train', 1)]
work_dir = './fine_tune_local_swin_C1'
seed = 0
gpu_ids = range(0, 1)
total_epochs = 300
